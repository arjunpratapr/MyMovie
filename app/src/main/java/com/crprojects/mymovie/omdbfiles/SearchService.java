package com.crprojects.mymovie.omdbfiles;
...
public class SearchService {
    ...
    public static class Detail implements Parcelable {
        ...
        protected Detail(Parcel in) {
            ...
            Type = in.readString();
            tomatoMeter = in.readString();
            tomatoImage = in.readString();
            tomatoRating = in.readString();
            tomatoReviews = in.readString();
            tomatoFresh = in.readString();
            tomatoRotten = in.readString();
            tomatoConsensus = in.readString();
            tomatoUserMeter = in.readString();
            tomatoUserRating = in.readString();
            tomatoUserReviews = in.readString();
            tomatoURL = in.readString();
            DVD = in.readString();
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(tomatoMeter);
            dest.writeString(tomatoImage);
            dest.writeString(tomatoRating);
            dest.writeString(tomatoReviews);
            dest.writeString(tomatoFresh);
            dest.writeString(tomatoRotten);
            dest.writeString(tomatoConsensus);
            dest.writeString(tomatoUserMeter);
            dest.writeString(tomatoUserRating);
            dest.writeString(tomatoUserReviews);
            dest.writeString(tomatoURL);
